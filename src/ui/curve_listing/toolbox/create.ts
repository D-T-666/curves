...
export const createCurveListingToolBox = (curve_index: number, scene_ref: Scene, callbacks: any): Element => {
    ...
    /* Create Edit Button */ {
        ...
        edit_button.addEventListener('click', (e) => {
            scene_ref._active_bezier = curve_index;
            scene_ref._active_bezier_mode = 0;
        })
